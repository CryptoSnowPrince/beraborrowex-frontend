...
export const Anchors: React.FC<React.PropsWithChildren> = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://beraborrowex.metabest.tech" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://beraborrowex.metabest.tech" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
