...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    const warningText = t("please make sure you're visiting https://beraborrowex.metabest.tech - check the URL carefully.")
    return warningText.split(/(https:\/\/beraborrowex.metabest.tech)/g)
  }, [t])
    ...
    <>
      ...
      {warningTextAsParts.map((text, i) => (
        <Text
          ...
          small
          as="span"
          bold={text === 'https://beraborrowex.metabest.tech'}
          color={text === 'https://beraborrowex.metabest.tech' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}
