...
export const DEFAULT_META: PageMeta = {
  title: 'Beraborrowex',
  description:
    'The most popular AMM on BERA by user count! Earn POLLEN through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by Beraborrowex), NFTs, and more, on a platform you can trust.',
