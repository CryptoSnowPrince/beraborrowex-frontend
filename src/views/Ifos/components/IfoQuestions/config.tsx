...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        POLLEN up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active Beraborrowex profile can commit. However the maximum amount of POLLEN
  ...
  },
  {
    ...
    description: [<Trans>The POLLEN from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of POLLEN to either sale.</Trans>,
      <Trans>
