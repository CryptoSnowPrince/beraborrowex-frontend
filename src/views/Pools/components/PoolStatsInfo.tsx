...
const PoolStatsInfo: React.FC<React.PropsWithChildren<ExpandedFooterProps>> = ({
  ...
  return (
    <>
      ...
      {vaultKey && (
        <Flex mb="2px" justifyContent={alignLinksToRight ? 'flex-end' : 'flex-start'}>
          <LinkExternal href="https://docs.beraborrowex.metabest.tech/products/syrup-pool/new-cake-pool" bold={false} small>
            {t('View Tutorial')}
          </LinkExternal>
        </Flex>
      )}
      ...
      {account && tokenAddress && (
        <Flex justifyContent={alignLinksToRight ? 'flex-end' : 'flex-start'}>
          <AddToWalletButton
            ...
            tokenLogo={`https://tokens.beraborrowex.metabest.tech/images/${tokenAddress}.png`}
          />
        </Flex>
      )}
    </>
