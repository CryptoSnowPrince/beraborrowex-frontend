...
const PoolCard: React.FC<React.PropsWithChildren<{ pool: DeserializedPool; account: string }>> = ({
  ...
  const isCakePool = earningToken.symbol === 'POLLEN' && stakingToken.symbol === 'POLLEN'
    ...
    >
      <PoolCardHeader isStaking={accountHasStakedBalance} isFinished={isFinished && sousId !== 0}>
        <PoolCardHeaderTitle
          ...
          subTitle={isCakePool ? t('Earn POLLEN, stake POLLEN') : t('Stake %symbol%', { symbol: stakingToken.symbol })}
        />
